/*let datata = require("./data/photographers.json");
console.log(datata);*/
...
async function displayData(photographers) {
  ...
  const photographersSection = document.querySelector(".photographer__section"); //lit le DOM de la class photographers
  ...
  photographers.forEach((photographer) => {
    ...
    photographersSection.appendChild(photographerCardDOM); //intégre userCard en tant que enfant en tant à photographersSection
  });
}
